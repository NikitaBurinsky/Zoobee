...
{
	public class ZoobeeAppDbContext : IdentityDbContext<BaseApplicationUser, ApplicationRole, Guid>, IApplicationDbContext
	{
		...
		public ZoobeeAppDbContext(DbContextOptions<ZoobeeAppDbContext> options) : base(options)
		{
